...
if __name__ == '__main__':
    try:
        ...
        # 작업 종료 시간 포함 결과 출력
        print(f"{datetime.now().strftime('%Y%m%d%H%M%S.%f')}", *result, file=sys.stdout, flush=True)
        sys.exit(0)
...
# python Sources/Main/Data_collection/GroundTemperature/groundtemperature.py --port /dev/ttyTHS1 --logger_addr 6 --channel 1 2 3 4 5 6